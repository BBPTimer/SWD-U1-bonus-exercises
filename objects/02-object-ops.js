...
let zoo = {
	...
	location: "Swope Park",
	adultTicketPrice: 21,
	childTicketPrice: 19.50,
	famousFeatures: ["Penguins", "Orangutans", "Stingrays"]
};
...
let museum = {
	...
	adultTicketPrice: 0,
	childTicketPrice: 0,
	famousFeatures: ["Shuttlecocks", "Bloch Building", "Thou Mayest"]
};

// TODO: create objects and put them in an array

let attractions = [zoo, museum];
...
for (let attraction of attractions) {
	let header = attraction.name + " - " + attraction.location;
	console.log(`
${"*".repeat(header.length)}
${header}
${"*".repeat(header.length)}
A favorite with the locals, the ${attraction.name} boasts over two features, including the ${attraction.famousFeatures[0]}, ${attraction.famousFeatures[1]}, and ${attraction.famousFeatures[2]}. Admission is $${attraction.adultTicketPrice} for adults and $${attraction.childTicketPrice} for children.`);
}