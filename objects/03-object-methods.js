...
console.log(add.doTheMath(42, 88));
console.log(subtract.doTheMath(42, 88));
console.log(multiply.doTheMath(42, 88));
...
function describeMMs() {
	console.log(`Slightly crunchy but very chocolatey`);
}
...
let werthers = {
	...
	describeCandy: function() {
		console.log(`Gross and best left for older people`);
	}
};
